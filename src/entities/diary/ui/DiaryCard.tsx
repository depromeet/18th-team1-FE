...
export const DiaryCard = ({
  ...
  <div className={cn("relative flex w-full flex-col gap-4 rounded-2xl bg-gray-50 p-5", className)}>
    ...
    <div className="absolute right-2.5 top-5 -rotate-90">
      <OptionMenu items={menuItems} trigger={<IcOption size={24} className="text-gray-300" />} />
    </div>
